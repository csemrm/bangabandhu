...
<head>
	...
	<link href="/bangabandhu/assets/css/main.css?c=-62169955200" media="all" rel="stylesheet"/>
...
<body>
	<div class="page">
		<div class="wrapper">
			<header class="page_header">
				<div class="logo"><object type="image/svg+xml" width="160" height="145" data="/bangabandhu/assets/images/_template_icons.svg#fuel"></object></div>
	...
	<footer class="row footer">
		...
		<p class="colophon">FUEL CMS is developed with love by <a href="http://thedaylightstudio.com" target="_blank">Daylight Studio</a> <object type="image/svg+xml" width="25" height="25" data="/bangabandhu/assets/images/_template_icons.svg#daylight"></object> &copy; 2014 Run for Daylight LLC, All Rights Reserved.</p>
	</footer>
</div>

<script src="/bangabandhu/assets/js/main.js?c=-62169955200" type="text/javascript" charset="utf-8"></script>
